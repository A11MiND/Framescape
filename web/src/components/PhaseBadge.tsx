...
const PHASE_STYLE: Record<string, { labelKey: string; icon: string; className: string; pulse?: boolean }> = {
  ...
  Suspended: {
    ...
    // Was ⏸ — that codepoint's default presentation is emoji (a colorful
    // pause icon on most platforms), unlike every other icon in this table.
    icon: '‖',
  ...
  // Was ⏱✕ — ⏱ (stopwatch) is also default-emoji-presentation.
